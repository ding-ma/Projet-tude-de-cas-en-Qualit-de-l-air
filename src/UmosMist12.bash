...
Type=species
Grille=regeta
FichierTICTAC=M:\Projet-tude-de-cas-en-Qualit-de-l-air\src/rarc/operation.scribeMat.mist.aq/${DateDebut}12_mist_anal
...
do
echo ${heure}
FileIn1=${PathIn}/${VersionGEM}/${DateDebut}12_mist_anal
if [ ! ${FileIn1}  ]; then
continue
else
echo "-------------"
