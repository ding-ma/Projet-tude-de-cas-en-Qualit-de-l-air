...
Type=species
Grille=regeta
FichierTICTAC=M:\Projet-tude-de-cas-en-Qualit-de-l-air\src/rarc/operation.forecasts.mach/${DateDebut}0300_000
...
do
FileOut1=${PathOut}/${Tag1}.${DateDebut}03_${DateFin}_${Grille}.fst
if [  ${FileOut1}  ]; then
rm -rf  ${FileOut1}
else
continue
