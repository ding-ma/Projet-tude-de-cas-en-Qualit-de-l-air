...
PathOut=/space/hall1/sitestore/eccc/oth/airq_central/rio001/Requete_Etudes_de_cas/TEST

PathIn=/space/hall1/sitestore/eccc/oth/airq_central/rio001/Requete_Etudes_de_cas/operation.forecasts.mach
...
FichierTICTAC=/space/hall1/sitestore/eccc/oth/airq_central/rio001/Requete_Etudes_de_cas/operation.forecasts.mach/${DateDebut}0800_000
...
ListePasse="00"
ListeHeures="000 001 002 003 004 005 006 007 008 009 010 011 012 013 014 015"
...
#		    FileIn1=${PathIn}/${VersionGEM}/${DateDebut}${jour}${passe}_${heure}
		    FileIn1=${PathIn}/${DateDebut}${jour}${passe}_${heure}
